...
## This website is an entertainment site that provide the user to read books whenever want and using any device as this website is made to be user freindly site and easy to use also it is a fully responsive website that makes it work perfectly on any type of devices which include (Tablet / Mobile phone / PC... etc)
